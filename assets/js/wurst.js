Prism.languages.wurst = {
  ...
  keyword:
    /\b(?:package|import|init|initlater|class|interface|module|enum|tuple|function|construct|ondestroy|return|if|else|elseif|switch|case|default|for|while|from|to|downto|step|in|break|continue|skip|let|var|new|destroy|extends|implements|override|static|abstract|public|private|protected|immutable|native|nativetype|globals|endglobals|constant|array|and|or|not|this|super|it|instanceof|castTo|div|mod|compiletime|begin|end|takes|returns|nothing|local|loop|endloop|exitwhen|set|call|then|endif|endfunction|endpackage)\b/,
  builtin:
